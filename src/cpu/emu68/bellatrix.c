...
/* Guest ROM and RAM backing, plus the 1 MB (AROS) ROM probe.
 *
 * Emu68-owned: it reads the ROM image through Emu68 kernel virtual space
 * (ROM_KVIRT / ROM_EXT_KVIRT) and publishes the reset vectors that
 * M68K_StartEmu() consumes. Sequenced by machine bring-up; see
 * src/runtime/bringup.c. */
