...
if(CONFIG_RIGEL)
    ...
    if(CONFIG_RIGEL_CONSOLE_SINK)
        target_compile_definitions(Emu68.elf PRIVATE CONFIG_RIGEL_CONSOLE_SINK=1)
    else()
        target_compile_definitions(Emu68.elf PRIVATE CONFIG_RIGEL_CONSOLE_SINK=0)
    endif()
    if(CONFIG_RIGEL_CHIPSET_CORE)
        target_compile_definitions(Emu68.elf PRIVATE CONFIG_RIGEL_CHIPSET_CORE=1)
    else()
        target_compile_definitions(Emu68.elf PRIVATE CONFIG_RIGEL_CHIPSET_CORE=0)
    endif()
else()
