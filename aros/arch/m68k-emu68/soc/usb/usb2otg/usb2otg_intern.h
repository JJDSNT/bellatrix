...
/* memset(): used by the TT-buffer helpers below, and implicitly declared
 * until now -- which on m68k means the compiler builds a call against a
 * guessed prototype rather than the builtin. */
#include <string.h>
