...
show meaningful content, then perform a race-free, visually clean handoff.
...
An arbitrary timer is not a candidate: boot duration varies and a time-based
bar or handoff would only hide the synchronization problem.
